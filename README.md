...
Mapeamento de presença digital e footprint
...
🎥 Avaliação técnica de vídeos (inconsistências e possíveis alterações)

🌐 Investigação de domínios e infraestrutura web

📄 Análise de documentos digitais e extração de artefatos relevantes

📑 Laudos Técnicos e Relatórios
Elaboração de documentação técnica estruturada, seguindo boas práticas de investigação digital e resposta a incidentes.

Relatórios claros, objetivos e baseados em evidências

Organização de achados técnicos para tomada de decisão
...
Com abordagem orientada a cenários reais, visando atuação em ambientes corporativos e equipes de segurança (SOC).
